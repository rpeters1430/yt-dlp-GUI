...
| `LIVE_DOWNLOAD_IDLE_TIMEOUT_MS` | `3600000` (60 min) | Same watchdog, but for active live recordings. Some live extractors can stay quiet much longer than VOD downloads without actually being hung. |
